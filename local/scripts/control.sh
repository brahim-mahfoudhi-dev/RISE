...
# sudo --login --non-interactive --user=vagrant -- \
#   ansible-playbook -i /vagrant/ansible/inventory.yml /vagrant/ansible/play.yml --vault-password-file /vagrant/ansible/playbooks/jenkins/files/security/vault_password.sh
